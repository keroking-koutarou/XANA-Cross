...
function resizeGame() {
    ...
    scaleFactor = Math.min(newWidth / GAME_WIDTH, newHeight / GAME_HEIGHT);
    ...
    gameArea.style.left = `${(newWidth - GAME_WIDTH * scaleFactor) / 2}px`;
    gameArea.style.top = `${(newHeight - GAME_HEIGHT * scaleFactor) / 2}px`;
